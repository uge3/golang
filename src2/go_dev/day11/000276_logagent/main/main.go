...
/*
	...
	fmt.Println("编译成二进制的运行方法：d:/project/src/go_dev/day11/000276_logagent> ")
	fmt.Println("go build go_dev/day11/000276_logagent/main")
	fmt.Println("在终端输入：d:/project/src/go_dev/day11/000276_logagent> main.exe ")
	fmt.Println("------退出程序！------")

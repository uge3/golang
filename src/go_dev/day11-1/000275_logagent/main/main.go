...
import (
	...
	"go_dev/day11/000275_logagent/tailf"
...
func main() { //固定写法，程序的入口
	...
	err = serverRun()
	if err != nil {
		logs.Error("serverRun 失败,错误：%v", err)
		return
	}
	logs.Info("程序退出！")
...
/*
	...
	fmt.Println("编译成二进制的运行方法：d:/project/src/go_dev/day11/000275_logagent> ")
	fmt.Println("go build go_dev/day11/000275_logagent/main")
	fmt.Println("在终端输入：d:/project/src/go_dev/day11/000275_logagent> main.exe ")
	fmt.Println("------退出程序！------")
